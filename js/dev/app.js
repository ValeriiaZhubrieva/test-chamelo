...
customMiniSelect();
if (document.querySelector("[data-fls-popup='popup-proposal']")) window.addEventListener("load", () => {
	setTimeout(() => {
		if (!document.querySelector("[data-fls-popup-open]")) window.flsPopup.open("popup-proposal");
	}, 5e3);
});
//#endregion
export { getHash as a, slideDown as c, dataMediaQueries as i, slideToggle as l, bodyLockStatus as n, isMobile as o, bodyUnlock as r, setHash as s, bodyLock as t, slideUp as u };
